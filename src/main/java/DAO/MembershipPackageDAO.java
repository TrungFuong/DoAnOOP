...
public class MembershipPackageDAO implements GenericDAO<MembershipPackage, String> {
    ...
    public boolean Insert(MembershipPackage p) {
        String sql = "INSERT INTO MembershipPackages (PackageId, PackageName, PackageDuration, PackagePrice, PackageDescription) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean Delete(String id) {
        String sql = "UPDATE MembershipPackages SET IsDeleted = 1 WHERE PackageId=?";
    ...
    public MembershipPackage FindById(String id) {
        String sql = "SELECT * FROM MembershipPackages WHERE PackageId=? AND IsDeleted=0";
    ...
    public List<MembershipPackage> FindAll() {
        ...
        String sql = "SELECT * FROM MembershipPackages WHERE IsDelted=0";
