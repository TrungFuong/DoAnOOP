...
/****** Object:  Database [Gym]    Script Date: 11/6/2025 10:44:34 AM ******/
DROP DATABASE [Gym]
GO
...
CREATE DATABASE [Gym]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Gym', FILENAME = N'D:\Coding\SQLServer\MSSQL16.MSSQLSERVER\MSSQL\DATA\Gym.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Gym_log', FILENAME = N'D:\Coding\SQLServer\MSSQL16.MSSQLSERVER\MSSQL\DATA\Gym_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
